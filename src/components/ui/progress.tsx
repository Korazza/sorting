...
export const Progress = ({ value, min, max }: ProgressProps) => {
	...
	return (
		<div className="flex w-full flex-1 items-center justify-start rounded-lg bg-background-light p-neu shadow-neu transition-[width] dark:bg-background-dark dark:shadow-neu-dark">
			<div
				ref={scope}
